...
const AddressModal = ({setShowAddressModal}) => {
    ...
    return (
        <form onSubmit={e => toast.promise(handleSubmit(e), {loading: 'Adding Address...'})}
            ...
            <div className="flex flex-col gap-5 text-slate-700 w-full max-w-sm mx-6">
                ...
                <button
                    className="bg-slate-800 text-white text-sm font-medium py-2.5 rounded-md hover:bg-slate-900 active:scale-95 transition-all">SAVE
                    ADDRESS
                </button>
            </div>
            <XIcon size={30} className="absolute top-5 right-5 text-slate-500 hover:text-slate-700 cursor-pointer"
